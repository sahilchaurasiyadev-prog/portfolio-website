  ...
  return (
    <div className="flex justify-center w-full fixed z-50 mt-4">
      <motion.nav
        ...
        className={`flex item-center justify-center ${colors.navBg} backdrop-blur-lg rounded-2xl px-4 lg:px-8 py-2 shadow-lg`}>
        <div className="flex items-center  justify-between w-full space-x-6 lg:space-x-8">
          ...
          <div className="flex items-center space-x-2">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className={`hidden lg:block px-6 py-2 rounded-full font-semibold text-white bg-gradient-to-r ${colors.button} shadow-md hover:shadow-lg transition-all duration-300`}>
              Hire Me
            </motion.a>
          </div>
          {/*Mobile menu button*/}
          ...
          <motion.div
            ...
            <div className="px-4 py-3 space-y-2">
              ...
              <motion.a
                ...
                className={`block py-3 px-4 text-center rounded-xl font-semibold text-white bg-gradient-to-r ${colors.button} shadow-md`}>
                Hire Me
              </motion.a>
            </div>
