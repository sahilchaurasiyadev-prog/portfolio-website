...
const Skills = ({ darkMode }) => {
    const skills = [
        ...
        { name: 'Node.js', icon: node, level: 90, color: 'from-green-500 to-emerald-500' },
        { name: 'Express.js', icon: express, level: 85, color: 'from-blue-500 to-cyan-500' },
        { name: 'MongoDB', icon: mongo, level: 80, color: 'from-green-500 to-emerald-500' },
        { name: 'MySQL', icon: mysql, level: 75, color: 'from-blue-500 to-indigo-500' },
        { name: 'GitHub', icon: github, level: 65, color: 'from-blue-500 to-indigo-500' },
        { name: 'Git', icon: git, level: 60, color: 'from-red-500 to-orange-500' },
    ];
    return (
        <section
            id="skills"
